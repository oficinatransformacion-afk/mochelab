...
type MaturityRow = { id: string; roleId:string;score: string; calibratedScore: string | null; evaluatedAt: string; period: { name: string }; level: { name: string };role:{name:string};selfAssessment:{submissionMode:"SELF"|"ADMIN_ASSISTED"|"FACILITATOR_ASSISTED"};modelVersion:{version:string;assessmentModel:{name:string}}|null };
